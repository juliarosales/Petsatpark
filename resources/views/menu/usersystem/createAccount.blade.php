@extends('layouts.index_layout_bt')
        ...
        <div class="row">
                  <div class="panel panel-bluedark">
                       <div class="panel-heading">
                          <img src="{{asset('img/User-group-1202174719.png')}}" class="user_group">  <div class="divmanagement">  Create User</div>
                        </div>
	       ...
	       <br>
	               ...
	               <div class="col-lg-12 botons-form" > 
                    ...
                    {!!Form::button('<i class="fa fa-save fa-1x"></i> REGISTER',[ 'type'=>'submit',  'class' => 'btn btn-success' , 'style' => 'margin-right: 15px;' ])!!}     
              ...
              {!!Form::close()!!}
                        ...
                        <div class="panel-footer">
                            ...
                            Please complete all fields with   <font class="color-red">*</font>   
